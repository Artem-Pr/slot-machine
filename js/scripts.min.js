...
window.onload = function () {
  ...
  var goalRowElem = document.querySelector('.goal-row');
  var goalSymbolElem = document.querySelector('.goal-symbol');
  var winKits = {
    'BAR': 'kit1',
    '2xBAR': 'kit1',
    '3xBAR': 'kit1',
  ...
  document.querySelector('.btn-start').addEventListener('click', function (e) {
    var goalRow = goalRowElem.value;
    var goalSymbol = goalSymbolElem.value;
...
var reelItem = function () {
  return function (config) {
    ...
    return function (goalRow, goalSymbol) {
