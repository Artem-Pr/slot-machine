...
window.onload = function () {
  ...
  function disableElements(isDisabled) {
    ...
    selectElems.forEach(function (item) {
      return item.disabled = isDisabled;
    });
    radioElems.forEach(function (item) {
      return item.disabled = isDisabled;
    });
  }
  ...
  function setSounds(action, elem) {
  ...
  document.getElementById('balance').onkeydown = function (e) {
    var numberSrt = e.target.value;
    var newNumberStr = numberSrt + e.key;
